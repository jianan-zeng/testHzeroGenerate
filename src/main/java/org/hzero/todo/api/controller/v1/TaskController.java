...
public class TaskController extends BaseController {
    ...
    @ApiOperation(value = "根据taskNumber分页查询task测试")
    @GetMapping
    public ResponseEntity<Page<Task>> pageTask(@PathVariable("organizationId") Long tenantId, Task task,
    ...
    @ApiImplicitParams({@ApiImplicitParam(value = "任务编号", paramType = "string")})
    ...
    public void deleteByTaskNumber(@PathVariable Long organizationId,
