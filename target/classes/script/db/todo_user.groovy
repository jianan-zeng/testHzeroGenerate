...
databaseChangeLog(logicalFilePath: 'todo_user.groovy') {
    changeSet(id: '2018-11-20-todo_user', author: 'your.email@email.com') {
        createTable(tableName: "TODO_USER") {
            ...
            column(name: 'EMPLOYEE_NAME', type: 'VARCHAR(30)', remarks: '员工名') { constraints(nullable:"false") }
            column(name: 'EMPLOYEE_NUMBER', type: 'VARCHAR(30)', remarks: '员工编号') { constraints(unique: true, nullable:"false") }
